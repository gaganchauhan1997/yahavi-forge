...
Concrete things to do in the 24 hours before the interview.`,
    ...
    'resume-output': {
      title: 'Resume Output',
      subtitle: 'All your saved drafts in one place — view, copy, or re-export',
      category: 'export',
      num: '18',
      icon: '📁',
      kind: 'resume-output',  // special renderer in runner.js
      inputs: [],
    },
    ...
    'omni-export': {
      title: 'Omni Export',
      subtitle: 'Everything you\'ve generated — compiled into one numbered document',
      category: 'export',
      num: '19',
      icon: '📦',
      kind: 'omni-export',    // special renderer in runner.js
      inputs: [],
    },
  }
  ...
  const SIDEBAR = [
    ...
    },
    {
      id: 'export',
      label: 'EXPORT',
      items: ['resume-output', 'omni-export'],
    },
  ]
